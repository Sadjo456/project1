...
export const fakeStoreUrl = {
  ...
  category(category_name) {
    ...
    return fetch(this.url + "products/category/" + category_name).then(
  ...
  const HTML = `
                    ...
                    <div class="top-half">
                        <div class="overlay">
                            ...
                            <button class="quick-buy" data-price="${
                              price + 0.99
                            }" data-name="${name}" data-img="${image}">quick buy</button>
                        </div>
                        <img
                            src="${image}"
                            alt=""
                    ...
                    <div class="bottom-half">
                        ...
                        <div class="price-wrapper">
                            <span class="price previous-price">${
                              (price * 1.15).toFixed(0) + 0.99
                            }</span>
...
export function quickbuyBtns() {
  document.querySelectorAll("button.quick-buy").forEach(quickbuyBtn);
}
// console.log("here");
